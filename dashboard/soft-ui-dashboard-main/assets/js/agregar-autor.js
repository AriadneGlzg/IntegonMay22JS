...
function agregarAJAX(){
                    ...
                    if($("#Funcion").val() === ""){
                        ...
                        if($("#Descripcion").val() === ""){
                            ...
                            if($("#Fecha").val()  === ""){
                                ...
                                if($("#Status").val() === "" ){
                                    $("#Status").focus();
                                    alert("Debes agregar un status: ONLINE/OFFLINE");
                                }
                                else{
                                    if($("#Status").val().toLowerCase() === "online" || $("#Status").val().toLowerCase() === "offline"  ){
                                        validados = true;
                                    }
                                    else{
                                        $("#Status").focus();
                                        alert(`"${$("#Status").val()}" no es un Status valido`);                                                                       
                                    }
                                }
                            }
                        }
    ...
    if(validados)
    {
        $.ajax({ //es la configuracion de una llamada usando ujquery
            ...
            success: function (data) {
                var url ="http://127.0.0.1:5500/Js/dashboard/soft-ui-dashboard-main/pages/tables.html";
